...
// is called.
func (iw *ignoreWriter) Insert(ctx *sql.Context, r sql.LazyRow) error {
...
func (iw *ignoreWriter) Update(ctx *sql.Context, old sql.LazyRow, new sql.LazyRow) error {
	if err := iw.errDuringStatementBegin; err != nil {
		return err
	}
...
// Close is called.
func (iw *ignoreWriter) Delete(ctx *sql.Context, r sql.LazyRow) error {
	if err := iw.errDuringStatementBegin; err != nil {
		return err
	}
