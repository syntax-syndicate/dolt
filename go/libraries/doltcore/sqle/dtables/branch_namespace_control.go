...
func (tbl BranchNamespaceControlTable) Insert(ctx *sql.Context, row sql.LazyRow) error {
	tbl.RWMutex.Lock()
...
func (tbl BranchNamespaceControlTable) Update(ctx *sql.Context, old sql.LazyRow, new sql.LazyRow) error {
	tbl.RWMutex.Lock()
	defer tbl.RWMutex.Unlock()
...
func (tbl BranchNamespaceControlTable) Delete(ctx *sql.Context, row sql.LazyRow) error {
	tbl.RWMutex.Lock()
	defer tbl.RWMutex.Unlock()
